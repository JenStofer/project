Summary Data CodeBook

This dataset contains 180 observations of 68 variables.

Subject - designates from which subject the measurements were taken
Activity - designates the activity the subject was performing during the measurements
	     - there are 6 Activities
		 - WALKING, WALKING_UPSTAIRS, WALKING_DOWNSTAIRS, SITTING, STANDING, LAYING

Each of the following variables is the mean of the set of observations for a particular
...
The measurements selected for this database come from the accelerometer and gyroscope 3-axial 
